          ...
          <div id="carouselExampleCaptions" class="carousel slide mb-5" data-bs-ride="carousel">
               ...
               <div class="carousel-inner">
                    <div class="carousel-item active">
                         <img src="<?= Yii::$app->request->baseUrl; ?>/frontend/web/img/kain3.jpg" class="d-block w-100"
                              alt="Gambar Kain" height="600px" />
                    ...
                    <div class="carousel-item">
                         <img src="<?= Yii::$app->request->baseUrl; ?>/frontend/web/img/kain1.jpg" class="d-block w-100"
                              alt="Gambar Kain" height="600px" />
                         <div class="carousel-caption d-none d-md-block">
                              <h5>Makloon</h5>
                    ...
                    <div class="carousel-item">
                         <img src="<?= Yii::$app->request->baseUrl; ?>/frontend/web/img/kain2.jpeg"
                              class="d-block w-100" alt="Gambar Kain" height="600px" />
                         <div class="carousel-caption d-none d-md-block">
                              <h5>Makloon</h5>
